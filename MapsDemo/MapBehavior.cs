...
namespace MapsDemo
{
	//From https://javiersuarezruiz.wordpress.com/2017/04/03/xamarin-forms-uso-de-mapas-basico-con-mvvm/
	public class MapBehavior:  BindableBehavior<Map>
    {
		private Map _map;

		public static readonly BindableProperty ItemsSourceProperty =
			BindableProperty.CreateAttached("ItemsSource", typeof(IEnumerable<Store>), typeof(MapBehavior),
